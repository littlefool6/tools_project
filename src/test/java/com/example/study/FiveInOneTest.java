...
//                && !"50309decfdde4587856b86ae911b05ae".equals(item.getID()));
    ...
    public void YHPCJL009() throws Exception {
        BufferedInputStream inputStream = FileUtil.getInputStream("C://Users//littlefool//Desktop//金道生物//金道11-13.xlsx");
...
//        kafkaUtils.sendMessage("ZYCSWXYS013", message);
    ...
    public void NEW_ZZTY_JWX() throws Exception {
        BufferedInputStream inputStream = FileUtil.getInputStream("C://Users//littlefool//Desktop//新双控//装置停用、检维修记录表.xlsx");
